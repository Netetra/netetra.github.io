...
Endpoint0で行われるControl転送は最初のパケットではDATA0で、そのあと残りのデータがあるならDATA1、DATA0...とする
送るデータのうちの最初はDATA0で余りがあるならその後は交互にする感じで、マウスのレポートは3byteだから一回で終わるのでずっとDATA0でいいと思ってました。
